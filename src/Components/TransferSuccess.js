      ...
      <Box>
        ...
        <Flex marginY="10%">
            <Box>
                ...
                <Text fontSize="16px" color="#07593D">{""} - Success</Text>
            </Box>
            <Spacer />
            <Box>
                <Text>Currency</Text>
                <Text fontSize="16px" color="#07593D">USD</Text>
            </Box>
        </Flex>
        <Flex marginY="10%">
            <Box>
            ...
            <Box>
                ...
                <Text fontSize="16px" color="#07593D">{getCurrentDate()}</Text>
            </Box>
        </Flex>
        <Flex justifyContent="center" alignItems="center">
            <Button width="100%" backgroundColor="#07593D" color="white">Close</Button>
        </Flex>
      </Box>
    </div>
  );
