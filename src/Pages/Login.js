...
import { Box, Button, Flex, Image, Text, Input, Checkbox } from '@chakra-ui/react'
  ...
  return (
    <div>
      ...
      <Box marginTop="2%">
        ...
        <Text marginTop="3%" fontSize="52px" fontWeight="300">Access your account online</Text>
        <Text fontSize="18px" marginTop="3%" fontWeight="600">Login to online banking</Text>
      <Box boxShadow="1px 2px 4px 0px rgba(0, 0, 0, 0.2)" padding="1% 2%" marginTop="2%" borderRadius="30px" width="28%">
        <Text marginTop="5%" marginBottom="1%" fontWeight="600" >Username</Text>
        <Input padding="7%" borderRadius="15px" border="3px solid #528400"/>
        <Flex marginTop="2%">
            <Checkbox color="green" />
            <Text marginLeft="10px" fontSize="14px" fontWeight="600">Remember my username</Text>
        </Flex>
        <Flex justifyContent="center" marginTop="8%" marginBottom="3%" alignItems="center">
        <Button backgroundColor="#528400" color="white" height="50px" borderRadius="25px" width="80%">Continue</Button>
        </Flex>
      </Box>
      <Box marginTop="2%" textAlign="center">
        <Text fontSize="14px">Forgot <Link className='link'>username</Link> or <Link className='link'>password</Link>?</Text>
        <Text fontSize="14px" marginTop="2%">Don’t have an Online Banking account? <Link className='link'>Enroll now.</Link></Text>
      </Box>
      <Flex width="60%" paddingTop="3%" justifyContent="center">  
        ...
        <Text marginTop="7%" fontSize="13px">Call <Link className='link'>1-800-REGIONS (1-800-734-4667)</Link> or visit <Link className='link'>Regions Help & Suppor</Link>t.</Text>
      </Flex>
    </div>
  )
}
